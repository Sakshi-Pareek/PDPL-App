      ...
      <div className="bg_abouthero py-5 px-lg-0 px-3">
       ...
       <Container className="p-xl-5 p-sm-4 p-3 my-lg-5 my-sm-4 max_w_835 mx-sm-auto rounded text-center position-relative z-2">
          ...
          <p
            ...
            data-aos="zoom-in"
          >
            For over 25 years, PDPL has been delivering health and empowering
            lives. Established in 1993 by Mr. Anil Kumar and Mr. Ashwani Kumar
            Bhatia, we are a trusted pharmaceutical distributor in India.
            Operating as Plus Distribution Pvt. Ltd., we are committed to
            providing genuine healthcare products under a robust regulatory
            framework, ensuring reliability and customer satisfaction.
          </p>
        </Container>
       </div>
      </div>
