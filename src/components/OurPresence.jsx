        ...
        <Container className="py-4">
          ...
          <Row>
            <Col lg={8} md={7}className="d-flex justify-content-center ">
              <img src={Map} alt="Map" className="w-100 max_w_500" data-aos="fade-right"/>
            </Col>
            <Col lg={4} md={5} xs={8}className="mt-5 " data-aos="fade-left">
              <h3 className="fs_md text-black ">
                <img src={Location} alt="Location" width={30} height={30} className="animation " />
                Company Warehouses
              </h3>
              <ul className="mb-0 d-flex flex-column gap-2 list_dots">
                <li className="text-black fs_md mb-0 cursor_pointer position-relative">Panipat</li>
                <li className="text-black fs_md mb-0 cursor_pointer position-relative">Delhi</li>
                <li className="text-black fs_md mb-0 cursor_pointer position-relative">Gurugram</li>
                <li className="text-black fs_md mb-0 cursor_pointer position-relative">Noida</li>
                <li className="text-black fs_md mb-0 cursor_pointer position-relative">Hisar</li>
                <li className="text-black fs_md mb-0 cursor_pointer position-relative">Jaipur</li>
                <li className="text-black fs_md mb-0 cursor_pointer position-relative">Dehradun</li>
                <li className="text-black fs_md mb-0 cursor_pointer position-relative">Bhopal</li>
                <li className="text-black fs_md mb-0 cursor_pointer position-relative">Ludhiana</li>
              </ul>
            </Col>
          </Row>
        </Container>
